        ...
        <main class="login-body">
            ...
            <form class="form-default" name="myform" action="student_register.jsp" method="POST">
                ...
                <%
                    ...
                    Student newStudent = new Student(no, name, email, password, degree, course, year);
                    ...
                    try
                    {
                        ...
                        // create a SQL statement
                        Statement stmt = con.createStatement();
                        String sql = "INSERT INTO student (roll_no, name, email_id, password, degree, course, year) VALUE ('" + newStudent.getRollNo() + "','" + newStudent.getName() + "','" + newStudent.getEmail() + "','" + newStudent.getPassword() + "','" + newStudent.getDegree() + "','" + newStudent.getCourse() + "','" + newStudent.getYear() + "')";
