...
<%@ page import="main.Model.Faculty" %>
...
%>
                ...
                <%
                    ...
                    Faculty newFaculty = new Faculty(name, username, email, password, degree, course, year, subject);
                    ...
                    try
                    {
                        ...
                        // create a SQL statement
                        Statement stmt = con.createStatement();
                        String sql = "insert into faculty (name, username, email_id, password, degree, course, year, subject) values('" + newFaculty.getName() + "','" + newFaculty.getUsername() + "','" + newFaculty.getEmail() + "','" + newFaculty.getPassword() + "','" + newFaculty.getDegree() + "','" + newFaculty.getCourse() + "','" + newFaculty.getYear() + "','" + newFaculty.getSubject() + "')";
