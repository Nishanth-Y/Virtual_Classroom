            ...
            <div class="header-bottom  header-sticky">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <!-- Logo -->
                        <h2 style="color: whitesmoke">Virtual Learning</h2>
            ...
            <form class="form-default" action="admin_student_manage.jsp" method="POST">
                ...
                <%
                    try
                    {
                        ...
                        String sql = "select roll_no, name, degree, course, year from student  where is_approved = 1";
                ...
                <div class="form-input pt-10 request">
